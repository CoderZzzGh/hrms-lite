    ...
    <div style={{ padding: '24px 28px' }}>
      ...
      {loading ? (
        ...
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow)' }}>
          <EmptyState
            title={search || deptFilter ? 'No matching employees' : 'No employees yet'}
          ...
          <tbody>
            {employees.map(emp => (
              ...
              >
                ...
                <Td>
                  <span style={{ fontFamily: 'var(--fm)', fontSize: 13, color: 'var(--text2)' }}>{emp.employee_id}</span>
                </Td>
                ...
                <Td style={{ textAlign: 'right' }}>
                  <Button
                    variant="danger"
                    size="sm"
                    onClick={() => setDelModal({ id: emp.id, name: emp.full_name })}
                  >
                    <TrashIcon /> Delete
                  </Button>
                </Td>
